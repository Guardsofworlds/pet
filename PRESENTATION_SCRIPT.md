...
**Rusty's listing** ready in two tabs if you can — that's your money moment.
...
These are widely-cited figures; say them with confidence, but know your sources in
case someone asks:
- **~10 million** lost/stolen pets per year in the US — commonly attributed to the ASPCA.
- **1 in 3 pets** lost in their lifetime — commonly cited by microchip/vet awareness groups (e.g., AAHA).
- **First 24 hours matter most** — supported by shelter return-rate data; reunions
  drop sharply the longer a pet is out.
- **Microchips dramatically raise return rates** (Lord et al., Ohio State): returned-to-owner
  rates were far higher for microchipped cats (~38% vs ~2%) and dogs (~52% vs ~22%).

If you're not 100% sure of a number on stage, soften it: *"somewhere around ten
million"* / *"research suggests."* Nobody will fault you for that, and it keeps you honest.
